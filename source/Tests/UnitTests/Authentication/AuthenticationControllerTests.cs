...
namespace Thinktecture.IdentityServer.Tests.Authentication
{
    ...
    public class AuthenticationControllerTests
    {
        ...
        protected HostDataProtector protector;
        ...
        public void Init()
        {
            ...
            {
                var provider = new DpapiDataProtectionProvider("test");
                protector = new HostDataProtector(provider);
