# 1.1.0 (04 Februar 2015) (04 Februar 2015)
 ...
 - [#854](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/854) - After deploying Identity Server 3, i am getting access denied error how fix it..
...
# 1.0.1 (01 Februar 2015) (01 Februar 2015)
 ...
 - [#821](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/821) - Reach claims from external provider in OpenIdConnectAuthenticationNotifications
...
# 1.0.0 (24 Januar 2015) (24 Januar 2015)
 ...
 - [#772](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/772) - Configuring multiple Identity Servers
 ...
 - [#701](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/701) - DisplayMode not set on ValidatedAuthorizeRequest
...
# rc (12 Januar 2015) (12 Januar 2015)
 ...
 - [#703](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/703) - Getting 401 Unauthorized with valid access token
 ...
 - [#643](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/643) - HSTS App Builder Extension doesn't allow a zero time duration for max-age
...
# beta4-1 (23 Dezember 2014) (23 Dezember 2014)
 ...
 - [#641](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/641) - Token Endpoint for password grant_type
 ...
 - [#512](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/512) - Add a signout API to IUserService
...
# beta4 (14 Dezember 2014) (14 Dezember 2014)
 ...
 - [#610](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/610) - Endpoint revoke token contributed by Raul Molina ([RaulMo7](https://github.com/RaulMo7))
 ...
 - [#462](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/462) - Question: extend Logout action in AuthenticationController 
...
# beta3-4 (23 November 2014)
 ...
 - [#531](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/531) - Registration Hook for External Providers
...
# beta3-2 (08 November 2014)
 ...
 - [#504](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/504) - In the MVC CodeFlowClient Manual where is it storing the Token Information
...
# beta3 (28 Oktober 2014) (28 Oktober 2014)
 ...
 - [#460](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/460) - support 'private' scopes to be kept out of .well-known/openid-configuration +enhancement
 ...
 - [#235](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/235) - Anti-forgery tokens where needed
...
# beta_2-1 (14 Oktober 2014) (14 Oktober 2014)
 ...
 - [#388](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/388) - Tests for access token TokenValidator
...
# Beta_1-2 (25 September 2014)
 ...
 - [#340](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/340) - Integrating Idsrv3
 ...
 - [#297](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/297) - @brockallen Hi, sorry to come back, Related to this issue #294. Loop on requests. I just reproduced with your examples. I will send the step in short time.
 ...
 - [#255](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/255) - Create Beta1 Documentation (Dominick)
...
# beta1 (31 Juli 2014) (31 Juli 2014)
 ...
 - [#225](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/225) - Adding Roles By Code
 ...
 - [#193](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/193) - Questing. Back to basic. Lifetime and Https considerations
 - [#192](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/192) - Not recognizing MembershipReboot.UserServiceFactory for startup usage
 - [#191](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/191) - Relationship between scope and user rol
 - [#190](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/190) - My Own Identity Provider For Relying Parties in my Institue
 - [#189](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/189) - Signing with secret key throws exception
 - [#188](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/188) - Question: Friction free signing of tokens
 - [#187](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/187) - Switch the LogLvl into suitable Diagnostic.Trace contributed by Poul Kjeldager Sørensen ([s093294](https://github.com/s093294))
 - [#186](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/186) - Authorize a concrete scope
 - [#184](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/184) - Question: Social network scenario
 - [#182](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/182) - [Todo] Update Trace Diagnostic logger with switch for lvls +enhancement
 - [#181](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/181) - What do spec say about persisting the consent given to a client by the user +enhancement
 - [#180](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/180) - Updated Build Action on items from content to None contributed by Poul Kjeldager Sørensen ([s093294](https://github.com/s093294))
 - [#179](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/179) - Who over engineered the build / packaging stuff ;)
 - [#178](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/178) - [Suggestion] HtmlResult/AssetManager.GetLayoutHtml+ abstraction +enhancement
 - [#177](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/177) - Owin AuthenticateAsync method always returns null, no request to identity server 
 - [#176](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/176) - Do you support the prompt parameter in the authorization requests?
 - [#175](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/175) - New logout architecture
 - [#174](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/174) - Rework Plugin Architecture and WS-Federation Plugin contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#173](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/173) - [Offtopic, Question] Azure Api Management and Identity Server
 - [#172](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/172) - Feature: Customize web views
 - [#171](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/171) - Question: How can I setup and acquire the user scopes from the access token?
 - [#170](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/170) - Is it possible to use IDS.v3 with a client custom login page with links to external providers?
 - [#169](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/169) - Allow to request certain IdP or authentication method during authentication request
 - [#167](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/167) - I'm not able to run any test client
 - [#165](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/165) - Add timestamps to Trace logger
 - [#164](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/164) - Allow providing custom assets (for re-branding the UI)
 - [#163](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/163) - Question: When to use IndentityManager v.s. IdentityServer 3
 - [#162](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/162) - Question: Support for JWT/SAML2 Bearer Flows?
 - [#161](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/161) - Issue when trying to use the Minimal Startup class contributed by Greg Pakes ([gregpakes](https://github.com/gregpakes))
 - [#159](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/159) - Feature: track user/client logins
 - [#158](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/158) - Fix new logging approach to work in release mode. contributed by Ciaran Jessup ([ciaranj](https://github.com/ciaranj)) +enhancement
 - [#157](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/157) - bug?
 - [#156](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/156) - Issue with embedded scenario very slow
 - [#155](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/155) - Multiple instances of client
 - [#154](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/154) - Tabs -> Spaces in logging files to be consistent with code base. contributed by Damian Hickey ([damianh](https://github.com/damianh))
 - [#153](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/153) - Make all Logger's private static members contributed by Damian Hickey ([damianh](https://github.com/damianh))
 - [#152](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/152) - Fixed null reference exception getting the logger contributed by Greg Pakes ([gregpakes](https://github.com/gregpakes))
 - [#151](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/151) - Prevent inlining when getting current class logger contributed by Damian Hickey ([damianh](https://github.com/damianh))
 - [#150](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/150) - [question] Is v3 ready for us to try in prod?
 - [#149](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/149) - Question: use access token for Ajax requests in OWIN sample
 - [#147](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/147) - using "roles" with claims based identity
 - [#145](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/145) - In the LocalTestFactory there is a givenname claim defined but i cant find in the incoming principle
 - [#144](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/144) - Remove Web API CORS attribute and add CORS middleware to host
 - [#143](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/143) - SAML2P support
 - [#142](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/142) - Make WsFedPluginOptions available to endpoints
 - [#141](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/141) - Add endpoint enabled checks
 - [#140](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/140) - Add logging to OIDC action results
 - [#139](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/139) - Rework logging for authentication subsystem
 - [#138](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/138) - Rework logging for OIDC endpoints
 - [#137](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/137) - New logging framework contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#136](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/136) - Turn WsFed CookieService into general TrackingCookieService
 - [#135](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/135) - Allow access to UserService from Custom Grant validator
 - [#134](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/134) - Idvrv3 responsibilities
 - [#133](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/133) - Add proper security headers
 - [#132](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/132) - Implement prompt=none
 - [#130](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/130) - Handling of the application related privileges in which component
 - [#129](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/129) - Timeline for production use?
 - [#128](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/128) - owin problems
 - [#127](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/127) - [Question] Best Practice: Code flow or Implicit flow.
 - [#126](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/126) - Fixes #125 - Avoid double-prompting on initial login contributed by Ciaran Jessup ([ciaranj](https://github.com/ciaranj))
 - [#125](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/125) - prompt=login support appears broken :/
 - [#124](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/124) - Add a config setting for controlling CORS policy on endpoints
 - [#123](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/123) - ClaimsTransformation and IdentityServer
 - [#122](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/122) - Add tracing to WS-Federation endpoint
 - [#120](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/120) - Setting RequireConsent to false doesn't seem to do anything
 - [#119](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/119) - Add whr support for WS-Fed contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#118](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/118) - Add HRD support to SignInMessage
 - [#117](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/117) - Add whr support to WS-Fed endpoint
 - [#116](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/116) - Unable to find version '1.0.0-alpha-20140528' of package 'Thinktecture.IdentityServer.v3'
 - [#115](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/115) - Patch 1 contributed by ([Dulf](https://github.com/Dulf))
 - [#114](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/114) - How to logoff in the MVC Owin sample
 - [#113](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/113) - Migration Story - IdSrv.v2 / AuthSrv.v1 to IdSrv.v3
 - [#112](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/112) - Allow specification of Schema for the MembershipRebootUserService
 - [#111](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/111) - Fill up PartialSignInRedirectPath
 - [#109](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/109) - Create EF-based persistence layer for core configuration
 - [#108](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/108) - Create separate repo and nuget for EF repositories
 - [#107](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/107) - Create separate repo and nuget for WS-Federation plugin
 - [#106](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/106) - Create separate repos and nugets for user services
 - [#105](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/105) - Add custom validation logic extensibility to access token validation endpoint
 - [#104](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/104) - Add support for encrypted tokens for WS-Fed endpoint
 - [#103](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/103) - Update factory Validate method
 - [#102](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/102) - Default to Trace logger
 - [#101](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/101) - email doesn't come back in token
 - [#100](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/100) - Config reorg contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#99](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/99) - Certificates and Token Validation
 - [#98](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/98) - Authorize each scope
 - [#97](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/97) - Custom ASP.Net Identity
 - [#96](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/96) - How do I add custom claims to the token (resource owner credentials)?
 - [#94](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/94) - Added json response mode for implicit flow contributed by ([DennisFrostlander](https://github.com/DennisFrostlander))
 - [#93](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/93) - add coordination between core and pluings to register signout urls contributed by Brock Allen ([brockallen](https://github.com/brockallen)) +enhancement
 - [#92](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/92) - Flow and access token verification in a disparate environment
 - [#91](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/91) - Split up Nugets for Core and User Services
 - [#84](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/84) - Switch to Damian's Logging "Framework" ?
 - [#83](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/83) - System.IdentityModel.Tokens.Jwt 4.0.0 breaking changes
 - [#81](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/81) - Make the Embedded FileSystem Optional
 - [#79](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/79) - Have one flow per client + client credentials flow
 - [#77](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/77) - Add json name overrides to allow using standard C# property names contributed by ([BrettStyles](https://github.com/BrettStyles)) +enhancement
 - [#76](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/76) - Client Credentials Grant Flow + claims, oh my!
 - [#67](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/67) - When to use a scope, and when to use a claim
 - [#66](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/66) - Question: WAAD integration
 - [#62](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/62) - Add sample API to Clients sample to show access token consumption
 - [#51](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/51) - Feature: Rebranding the UI +enhancement
 - [#50](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/50) - Thinktecture.IdentityModel.Oidc project +enhancement
 - [#49](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/49) - Persistence Data stores +enhancement
 - [#46](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/46) - Expose "IsUserActive" functionality from IUserService
 - [#28](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/28) - Allow simple customization for identity libraries
 - [#25](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/25) - Identity DB samples
 - [#23](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/23) - Access Token Validation Endpoint
 - [#15](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/15) - Improve interaction between protocol endpoint and authentication subsystem
...
# WsFed_POC (14 Mai 2014) (14 Mai 2014)
 ...
 - [#88](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/88) - Add WS-Federation endpoint
 - [#86](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/86) - Calling OAuth endpoint
 - [#85](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/85) - Crossover of concerns - WebApi in core delivering HTML content
 - [#82](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/82) - Api Scope Partioning with Scope and Scope Claims
 - [#80](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/80) - Clients : Implicit Javascript Client
 - [#78](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/78) - how it works the PartialSignInRedirectPath?
 - [#75](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/75) - Why does IdentityServerServiceFactory use static stores
 - [#74](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/74) - IdentityManager Preview
...
# SelfContained_Nuget (05 Mai 2014) (05 Mai 2014)
 ...
 - [#68](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/68) - OpenIdConnectModule - Only applies claims from the identity token, ignores the access token
 - [#65](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/65) - Single sign on
 - [#64](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/64) - Build script contributed by Damian Hickey ([damianh](https://github.com/damianh)) +enhancement
 - [#63](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/63) - Sample API for clients sample contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#61](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/61) - oauth2 authentication
 - [#60](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/60) - Add build script and nuspec +enhancement
...
# HostingEnhancements (22 April 2014)
 ...
 - [#57](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/57) - no external identity -- exiting to login page
 - [#56](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/56) - Allow response type of "id_token token" for form_post response mode contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#55](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/55) - Allow id_token token for form_post response mode
 - [#53](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/53) - How v3 compare to v2
 - [#52](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/52) - Default Constructor on Token contributed by Poul Kjeldager Sørensen ([s093294](https://github.com/s093294))
 - [#48](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/48) - Question: When Idsrv 3 is done, is Authorization Server still needed?
 - [#47](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/47) - HomeRealms - Per client restrictions?
 - [#45](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/45) - Password required to import certificate idsrv3test.pfx into Local Windows Store (Local Computer\Personal)
 - [#44](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/44) - OAuth client credentials signing/encryption
 - [#43](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/43) - Poor Man's Delegation Actas with OpenIdConnectionAuthenticationModule and idSrv3
 - [#42](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/42) - WebAPI for create user, login.
 - [#41](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/41) - Associate external logins to local login
 - [#40](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/40) - Test Preview 1 on Azure WebSites
 - [#38](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/38) - Modify #Debug contributed by Damiano ([dandresini](https://github.com/dandresini)) +enhancement
 - [#37](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/37) - Xamarin
 - [#36](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/36) - Embedded pfx in TestServices contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege)) +enhancement
 - [#35](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/35) - How to create an account and login from iOS application?
 - [#34](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/34) - What is differences between Thinktecture.IdentityServer.v3 and Thinktecture.IdentityServer.v2
 - [#33](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/33) - An exception of type 'System.InvalidOperationException' occurred in System.Core.dll but was not handled in user code
 - [#32](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/32) - Make public test installation available
...
# Preview1 (09 April 2014)
 ...
 - [#27](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/27) - Consent screen: Make enter key trigger "allow" +enhancement
 - [#26](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/26) - Move IdMgr out
 - [#22](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/22) - OWIN/Katana Sample
 - [#21](https://github.com/IdentityServer/Thinktecture.IdentityServer3/pull/21) - Async contributed by Dominick Baier ([leastprivilege](https://github.com/leastprivilege))
 - [#20](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/20) - Think about lifetime mgmt of objects created via IdentityServerServiceFactory
 - [#19](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/19) - Changes to consent screen
 - [#17](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/17) - Login Page: Make it work on all current browsers / devices
 - [#16](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/16) - Login Page does not work in WPF Browser Control
 - [#14](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/14) - Sample Native Client
 - [#12](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/12) - Consent screen
 - [#10](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/10) - Implement support for assertion flow
 - [#9](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/9) - Implement support for client credentials flow
 - [#8](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/8) - Implement support for resource owner credential flow
 - [#7](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/7) - Support both reference and self contained access tokens
 - [#6](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/6) - Login Page: Support for external identity providers
 - [#5](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/5) - Login Page: Automatic redirect back to protocol endpoint
 - [#4](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/4) - Define core interface for user management
 - [#3](https://github.com/IdentityServer/Thinktecture.IdentityServer3/issues/3) - Persist authorize request parameters using cookie
